...
// ─────────────────────────────────────────────────────────────────────────────
// STATS HEADER — total, avg score, best score
// ─────────────────────────────────────────────────────────────────────────────
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        _statCol(avg > 0 ? '$avg%' : '--', isAr ? 'المتوسط' : 'Avg Score',
            AppColors.cyan),
        _divider(),
        _statCol(best > 0 ? '$best%' : '--', isAr ? 'الأفضل' : 'Best Score',
            AppColors.emerald),
      ]),
    );
  }
...
// ─────────────────────────────────────────────────────────────────────────────
// PREMIUM INTERVIEW CARD — expandable feedback
// ─────────────────────────────────────────────────────────────────────────────
        ...
        child: GlassCard(
          ...
          child: Column(
            ...
            children: [
              ...
              // ── Score bar (if completed + has score) ──────
...
// ─────────────────────────────────────────────────────────────────────────────
// FEEDBACK PANEL — shown when card is expanded
// ─────────────────────────────────────────────────────────────────────────────
        ...
        children: [
          ...
          if (overall.isNotEmpty) ...[
            Row(children: [
              ...
              const SizedBox(width: 6),
              Text(
                isAr ? 'التقييم العام' : 'AI Feedback',
                style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w800,
                    color: scoreColor),
