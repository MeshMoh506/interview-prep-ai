...
class _ProfilePageState extends ConsumerState<ProfilePage>
  ...
  Widget build(BuildContext context) {
    ...
    final s = AppStrings.of(context);
    final isAr = Directionality.of(context) == TextDirection.rtl;
    final bg = isDark ? const Color(0xFF06040B) : const Color(0xFFF6F7FC);
            ...
            TapScale(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  border: Border.all(
                      color: AppColors.violet.withOpacity(0.3), width: 2),
                  boxShadow: [
                    BoxShadow(
              ...
              child: TapScale(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    border: Border.all(
                        color: isDark ? const Color(0xFF06040B) : Colors.white,
                        width: 3),
                    boxShadow: [
                      BoxShadow(
        ...
        if (profile.jobTitle?.isNotEmpty == true) ...[
          Text(
            ...
            style: TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w600,
              color: isDark ? Colors.white70 : AppColors.lightInk40,
            ),
          ),
          const SizedBox(height: 6),
        ],
        Container(
          ...
          child: Row(
            ...
            children: [
              Icon(Icons.alternate_email_rounded,
                  size: 13,
                  color: isDark ? Colors.white30 : AppColors.lightInk40),
              const SizedBox(width: 6),
              Text(
                profile.email,
                style: TextStyle(
            ...
            child: Row(
              ...
              children: [
                Icon(
                  ...
                  size: 15,
                  color: editMode ? AppColors.rose : Colors.white,
                ),
                const SizedBox(width: 8),
                Text(
                  editMode
...
class _StatPill extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bodyColor = isDark ? const Color(0xFF13111A) : Colors.white;
    return Expanded(
      child: TapScale(
        onTap: onTap ?? () {},
        scaleDownTo: onTap != null ? 0.94 : 1.0,
        child: Container(
...
class _AchievementsRowState extends State<_AchievementsRow>
  ...
  @override
  Widget build(BuildContext context) {
    final cardColor = widget.isDark ? const Color(0xFF13111A) : Colors.white;
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20),
      child: Column(
        children: [
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  bottomLeft: Radius.circular(_open ? 0 : 22),
                  bottomRight: Radius.circular(_open ? 0 : 22),
                ),
                border: Border.all(
                  color: widget.isDark
                      ? Colors.white.withOpacity(0.04)
                ...
                boxShadow: [
                  BoxShadow(
                    color:
                        Colors.black.withOpacity(widget.isDark ? 0.15 : 0.03),
                    blurRadius: 12,
                    offset: const Offset(0, 4),
                  )
                ],
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          widget.isAr ? 'الإنجازات المفتوحة' : 'Achievements',
                          style: TextStyle(
                            fontWeight: FontWeight.w800,
                            fontSize: 15,
                            color: widget.isDark
                        ...
                        Text(
                          widget.isAr
                              ? 'أتممت ${widget.interviewCount} مقابلة بنجاح'
                              : '${widget.interviewCount} sessions evaluated',
                          style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w500,
                            color: widget.isDark
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              isDark ? const Color(0xFF13111A) : Colors.black.withOpacity(0.04),
          borderRadius: BorderRadius.circular(16),
        ),
        ...
        child: TabBar(
          controller: tabs,
          indicator: BoxDecoration(
            color: isDark ? const Color(0xFF23212E) : Colors.white,
            borderRadius: BorderRadius.circular(12),
            boxShadow: [
              BoxShadow(
          ...
          unselectedLabelColor: isDark ? Colors.white38 : AppColors.lightInk40,
          labelStyle:
          ...
          tabs: [
            Tab(text: isAr ? 'عام' : 'General'),
            Tab(text: isAr ? 'التفضيلات' : 'Settings'),
            Tab(text: isAr ? 'الأمان' : 'Security'),
          ],
        ),
      ),
...
class _GeneralContentState extends ConsumerState<_GeneralContent> {
  ...
  Future<void> _save() async {
    ...
    if (!mounted) return;
    ScaffoldMessenger.of(context).showSnackBar(_okSnack(
        widget.isAr ? '✅ تم حفظ البيانات' : '✅ Settings synchronized!'));
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _SectionLabel(widget.isAr ? 'المعلومات الشخصية' : 'Basic Info',
              isDark: widget.isDark),
          const SizedBox(height: 10),
          _FormCard(
            isDark: widget.isDark,
            children: [
              _FormField(
                label: widget.isAr ? 'الاسم كاملاً' : 'Full Name',
                ctrl: _name,
                icon: Icons.person_outline_rounded,
                isDark: widget.isDark,
              ),
              ...
              _Divider(isDark: widget.isDark),
              _FormField(
                label: widget.isAr ? 'الموقع المهني' : 'Location',
                ctrl: _location,
                icon: Icons.location_on_outlined,
                isDark: widget.isDark,
              ),
              _Divider(isDark: widget.isDark),
              _FormField(
                label: widget.isAr ? 'النبذة التعريفية' : 'Bio',
                ctrl: _bio,
                icon: Icons.notes_rounded,
                isDark: widget.isDark,
                maxLines: 2,
          ...
          const SizedBox(height: 24),
          _SectionLabel(widget.isAr ? 'المنصات الرقمية' : 'Links & Platforms',
              isDark: widget.isDark),
          const SizedBox(height: 10),
          _FormCard(
            isDark: widget.isDark,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _SectionLabel(isAr ? 'تفضيلات النظام' : 'Preferences',
              isDark: isDark),
          const SizedBox(height: 10),
          _MenuCard(
            isDark: isDark,
            children: [
              _MenuRow(
                ...
                title: darkMode
                    ? (isAr ? 'المظهر الداكن' : 'Dark Interface')
                    : (isAr ? 'المظهر الفاتح' : 'Light Interface'),
                trailing: _PillSwitch(
                  on: darkMode,
                  onTap: () => ref.read(themeProvider.notifier).toggle(context),
                ),
              ...
              _MenuRow(
                ...
                icon: Icons.language_rounded,
                iconColor: AppColors.violet,
                title: isAr ? 'لغة التطبيق' : 'Application Language',
                trailing: const LangToggleButton(),
              ),
            ],
          ),
          const SizedBox(height: 24),
          _SectionLabel(isAr ? 'إشعارات الدفع' : 'Notifications',
              isDark: isDark),
          const SizedBox(height: 10),
          _MenuCard(
            isDark: isDark,
            children: [
              _MenuRow(
                  ...
                  icon: Icons.notifications_outlined,
                  iconColor: AppColors.amber,
                  title: isAr ? 'تذكيرات جلسات التدريب' : 'Interview Reminders',
                  trailing: _SoonBadge()),
              _Divider(isDark: isDark),
              _MenuRow(
                  isDark: isDark,
...
class _SecurityContentState extends ConsumerState<_SecurityContent> {
  ...
  Future<void> _update() async {
    ...
    if (_c2.text.length < 6)
      return _err(isAr
          ? 'كلمة المرور قصيرة جداً (٦ خانات)'
          : 'Password variant too short');
    if (_c2.text != _c3.text) {
      return _err(isAr
          ? 'كلمتا المرور غير متطابقتين'
          : "Security entries do not match");
    }
    if (_c2.text == _c1.text)
      return _err(isAr
          ? 'يجب اختيار كلمة مرور جديدة'
          : 'Must be a completely unique variation');
    ...
    if (err == null) {
      ...
      _c2.clear();
      _c3.clear();
      ScaffoldMessenger.of(context).showSnackBar(_okSnack(widget.isAr
          ? '✅ تم تحديث كلمة المرور'
          : '✅ Authentication payload updated!'));
    } else {
      _err(err);
    }
  }
  ...
  Future<void> _del() async {
    final ok = await showDialog<bool>(
      ...
      builder: (_) => _ConfirmDialog(
        ...
        isAr: widget.isAr,
        title:
            '⚠️ ${widget.isAr ? "حذف الحساب نهائياً؟" : "Purge Account Metadata?"}',
        body: widget.isAr
            ? 'تحذير: سيتم حذف كافة ملفاتك وجلساتك التدريبية ولا يمكن التراجع.'
            : 'Warning: This executes a total database scrub. This baseline process is irreversible.',
        confirmLabel: widget.isAr ? 'تأكيد الحذف' : 'Purge All Data',
        confirmColor: AppColors.rose,
      ),
    );
    if (ok == true && mounted) {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          _SectionLabel(
              widget.isAr ? 'تعديل بيانات الأمان' : 'Authentication Settings',
              isDark: widget.isDark),
          const SizedBox(height: 10),
          _FormCard(
            isDark: widget.isDark,
            children: [
              _FormField(
                  label:
                      widget.isAr ? 'كلمة المرور الحالية' : 'Current Password',
                  ctrl: _c1,
                  icon: Icons.lock_outline_rounded,
                  isDark: widget.isDark,
                  obs: _h1,
              ...
              _Divider(isDark: widget.isDark),
              _FormField(
                  label: widget.isAr ? 'كلمة المرور الجديدة' : 'New Password',
                  ctrl: _c2,
                  icon: Icons.lock_rounded,
                  isDark: widget.isDark,
                  obs: _h2,
              ...
              _FormField(
                  label:
                      widget.isAr ? 'تأكيد كلمة المرور' : 'Confirm Encryption',
                  ctrl: _c3,
                  icon: Icons.lock_reset_rounded,
                  isDark: widget.isDark,
                  obs: _h3,
          ...
          const SizedBox(height: 20),
          _SaveButton(
              label: widget.isAr ? 'تحديث كلمة المرور' : 'Commit Security Keys',
              loading: widget.isSaving,
              onTap: _update),
          const SizedBox(height: 32),
          _SectionLabel(widget.isAr ? 'منطقة الخطر' : 'Danger Zone',
              isDark: widget.isDark),
          const SizedBox(height: 10),
          GestureDetector(
            onTap: _del,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.isAr
                              ? 'مسح كافة سجلات المقابلات والبيانات التفضيلية'
                              : 'Wipe analytics and localized model matrices',
                          style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon,
              size: 18, color: isDark ? Colors.white30 : AppColors.lightInk40),
          const SizedBox(width: 14),
          Expanded(
            child: TextFormField(
              controller: ctrl,
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(
            ...
            fontWeight: FontWeight.w900,
            letterSpacing: 1.2,
            color: isDark ? Colors.white24 : AppColors.lightInk40),
      ),
    );
  }
}
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          gradient: loading
              ? null
              : const LinearGradient(
                  colors: [AppColors.violet, Color(0xFF6366F1)],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
          color: loading
        ...
        child: Center(
          child: loading
              ? const SizedBox(
                  ...
                  height: 22,
                  child: CircularProgressIndicator(
                      color: AppColors.violet, strokeWidth: 2.5))
              : Text(label,
                  style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.w800,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(20),
            color: on ? AppColors.violet : Colors.grey.withOpacity(0.3)),
        child: AnimatedAlign(
          duration: const Duration(milliseconds: 200),
          curve: Curves.easeInOut,
          alignment: on ? Alignment.centerRight : Alignment.centerLeft,
  ...
  Widget build(BuildContext context) {
    return TapScale(
      ...
      child: Container(
        ...
        child: Icon(icon,
            size: 18,
            color: color ?? (isDark ? Colors.white70 : AppColors.lightInk)),
      ),
    );
  }
}
...
class _ConfirmDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      backgroundColor: isDark ? const Color(0xFF13111A) : Colors.white,
      ...
      content: Text(body,
          style: TextStyle(
              color: isDark ? Colors.white60 : AppColors.lightInk40,
              fontSize: 14,
              height: 1.4)),
      actions: [
        TextButton(
...
// ══════════════════════════════════════════════════════════════════
// HIGHER FIDELITY SHIMMER LOADING
// ══════════════════════════════════════════════════════════════════
class _LoadingView extends StatefulWidget {
  final bool isDark;
  const _LoadingView({required this.isDark});
...
class _LoadingViewState extends State<_LoadingView>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: _a,
      builder: (_, __) {
        final v = 0.03 + 0.07 * _a.value;
        final hi = widget.isDark
            ? Colors.white.withOpacity(v)
            : Colors.black.withOpacity(v);
        final lo = widget.isDark
            ? Colors.white.withOpacity(v * 0.4)
            : Colors.black.withOpacity(v * 0.4);
        final card = widget.isDark ? const Color(0xFF13111A) : Colors.white;
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                                ...
                                height: 34,
                                decoration: BoxDecoration(
                                    shape: BoxShape.circle, color: hi)),
                            const SizedBox(height: 10),
                            bone(32, 14, r: 5, fill: true),
                            const SizedBox(height: 4),
                            bone(40, 8, r: 4)
                          ],
                        ),
